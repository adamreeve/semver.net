...
namespace SemVer.Tests
{
    public class VersionComparison
    {
        ...
        [InlineData("1.2.3-0", "v 1.2.3-0")]
        [InlineData("1.2.3-0", "= 1.2.3-0")]
        [InlineData("1.2.3-0", " v1.2.3-0")]
        [InlineData("1.2.3-0", " =1.2.3-0")]
        [InlineData("1.2.3-0", " v 1.2.3-0")]
        [InlineData("1.2.3-0", " = 1.2.3-0")]
        [InlineData("1.2.3-1", "v1.2.3-1")]
        [InlineData("1.2.3-1", "=1.2.3-1")]
        [InlineData("1.2.3-1", "v 1.2.3-1")]
        [InlineData("1.2.3-1", "= 1.2.3-1")]
        [InlineData("1.2.3-1", " v1.2.3-1")]
        [InlineData("1.2.3-1", " =1.2.3-1")]
        [InlineData("1.2.3-1", " v 1.2.3-1")]
        ...
        [InlineData("1.2.3-beta", "v 1.2.3-beta")]
        [InlineData("1.2.3-beta", "= 1.2.3-beta")]
        [InlineData("1.2.3-beta", " v1.2.3-beta")]
        [InlineData("1.2.3-beta", " =1.2.3-beta")]
        [InlineData("1.2.3-beta", " v 1.2.3-beta")]
        [InlineData("1.2.3-beta", " = 1.2.3-beta")]
        [InlineData("1.2.3-beta+build", " = 1.2.3-beta+otherbuild")]
        [InlineData("1.2.3+build", " = 1.2.3+otherbuild")]
        [InlineData("1.2.3-beta+build", "1.2.3-beta+otherbuild")]
        [InlineData("1.2.3+build", "1.2.3+otherbuild")]
        [InlineData(" v1.2.3+build", "1.2.3+otherbuild")]
        public void Equality(string v0s, string v1s)
        {
            var v0 = new Version(v0s);
            var v1 = new Version(v1s);
